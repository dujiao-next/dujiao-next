...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.guest_password_too_weak":                  "订单密码至少需要 12 个字符",
	...
	LocaleTW: {
		...
		"error.guest_password_too_weak":                  "訂單密碼至少需要 12 個字元",
	...
	LocaleEN: {
		...
		"error.guest_password_too_weak":                  "Order password must be at least 12 characters",
