...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.upstream_unauthorized":            "身份验证失败",
		"error.upstream_invalid_credentials":     "凭证无效",
		"error.upstream_bad_request":             "请求参数错误",
		"error.upstream_internal_error":          "服务器内部错误",
		"error.upstream_product_id_required":     "缺少商品 ID",
		"error.upstream_product_unavailable":     "商品不可用",
		"error.upstream_sku_not_found":           "SKU 不存在",
		"error.upstream_sku_not_active":          "SKU 未启用",
		"error.upstream_sku_unavailable":         "SKU 无效或不可用",
		"error.upstream_invalid_order_id":        "无效的订单 ID",
		"error.upstream_order_not_found":         "订单不存在",
		"error.upstream_invalid_order_params":    "订单参数无效",
		"error.upstream_insufficient_stock":      "商品库存不足",
		"error.upstream_insufficient_balance":    "钱包余额不足",
		"error.upstream_manual_form_invalid":     "手动表单数据无效",
		"error.upstream_cancel_not_allowed":      "当前状态不允许取消订单",
		"error.upstream_invalid_callback_url":    "回调地址无效",
		"error.upstream_list_failed":             "获取列表失败",
		"error.upstream_order_create_failed":     "创建订单失败",
	},
	LocaleTW: {
		"error.jwt_secret_missing":                       "JWT secret 未配置",
		"error.auth_header_missing":                      "缺少 Authorization header",
		...
		"error.upstream_unauthorized":            "身份驗證失敗",
		"error.upstream_invalid_credentials":     "憑證無效",
		"error.upstream_bad_request":             "請求參數錯誤",
		"error.upstream_internal_error":          "伺服器內部錯誤",
		"error.upstream_product_id_required":     "缺少商品 ID",
		"error.upstream_product_unavailable":     "商品不可用",
		"error.upstream_sku_not_found":           "SKU 不存在",
		"error.upstream_sku_not_active":          "SKU 未啟用",
		"error.upstream_sku_unavailable":         "SKU 無效或不可用",
		"error.upstream_invalid_order_id":        "無效的訂單 ID",
		"error.upstream_order_not_found":         "訂單不存在",
		"error.upstream_invalid_order_params":    "訂單參數無效",
		"error.upstream_insufficient_stock":      "商品庫存不足",
		"error.upstream_insufficient_balance":    "錢包餘額不足",
		"error.upstream_manual_form_invalid":     "手動表單資料無效",
		"error.upstream_cancel_not_allowed":      "目前狀態不允許取消訂單",
		"error.upstream_invalid_callback_url":    "回呼地址無效",
		"error.upstream_list_failed":             "取得列表失敗",
		"error.upstream_order_create_failed":     "建立訂單失敗",
	},
	LocaleEN: {
		...
		"error.upstream_unauthorized":            "Authentication failed",
		"error.upstream_invalid_credentials":     "Invalid credentials",
		"error.upstream_bad_request":             "Invalid request parameters",
		"error.upstream_internal_error":          "Internal server error",
		"error.upstream_product_id_required":     "Product ID is required",
		"error.upstream_product_unavailable":     "Product is not available",
		"error.upstream_sku_not_found":           "SKU not found",
		"error.upstream_sku_not_active":          "SKU is not active",
		"error.upstream_sku_unavailable":         "SKU is invalid or not available",
		"error.upstream_invalid_order_id":        "Invalid order ID",
		"error.upstream_order_not_found":         "Order not found",
		"error.upstream_invalid_order_params":    "Invalid order parameters",
		"error.upstream_insufficient_stock":      "Product stock is insufficient",
		"error.upstream_insufficient_balance":    "Wallet balance is insufficient",
		"error.upstream_manual_form_invalid":     "Manual form data is invalid",
		"error.upstream_cancel_not_allowed":      "Order cannot be canceled in current status",
		"error.upstream_invalid_callback_url":    "Invalid callback URL",
		"error.upstream_list_failed":             "Failed to list",
		"error.upstream_order_create_failed":     "Failed to create order",
	},
}
